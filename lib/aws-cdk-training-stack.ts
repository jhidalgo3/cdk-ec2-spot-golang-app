...
export class AwsCdkTrainingStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
    ...
    const vpcId = "vpc-051cc61437006417f"
    const region = "${this.region}"

    const vpc = ec2.Vpc.fromLookup(this, 'ImportVPC',{ isDefault: false, vpcId: vpcId });

    //const vpc = ec2.Vpc.fromVpcAttributes(this, 'Vpc', {
    //  vpcId:vpcId ,
    //  availabilityZones: ['eu-west-1b'],
    //  publicSubnetIds: ['subnet-096e4a431da5efce5'],
    //  privateSubnetIds: ['subnet-09040708f8fd276b3'],
    //});
